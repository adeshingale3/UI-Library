...
const TeamMemberCard = () => {
    return (
        <div className='h-80 w-60 rounded-4xl shadow-lg m-10 overflow-hidden z-10 relative hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer group'>
